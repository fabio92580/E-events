...
public class HomeServizioCatering extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_servizio_catering);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent openPage1 = new Intent(HomeServizioCatering.this, DescrizioneEvento.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_cerca_locali) {
            Intent openPage1= new Intent(HomeServizioCatering.this, CercaLocale.class);
            startActivity(openPage1);        }
        else if (id == R.id.nav_cerca_eventi) {
            Intent openPage1= new Intent(HomeServizioCatering.this, CercaEvento.class);
            startActivity(openPage1);
        } else if (id == R.id.nav_accedi_registrati) {
            Intent openPage1= new Intent(HomeServizioCatering.this, Accedi.class);
            startActivity(openPage1);
        }else if (id == R.id.nav_area_riservata) {
            Intent openPage1= new Intent(HomeServizioCatering.this, ServizioCateringRiservato.class);
            startActivity(openPage1);
        }else if (id== R.id.nav_impostazioni_eventi){
            Intent openPage1= new Intent(HomeServizioCatering.this, HomeServizioTrasporti.class);
            startActivity(openPage1);
        }else if (id == R.id.nav_impostazioni_locali) {
            Intent openPage1= new Intent(HomeServizioCatering.this, HomeServizioTrasporti.class);
            startActivity(openPage1);
        }else if (id== R.id.nav_notifiche){
            Intent openPage1= new Intent(HomeServizioCatering.this, ListaNotifiche.class);
            startActivity(openPage1);
        }else if (id == R.id.nav_eventi_prenotati) {
            Intent openPage1= new Intent(HomeServizioCatering.this, ListaEventi.class);
            startActivity(openPage1);
        }else if (id== R.id.nav_gestisci_ristorazione){
            Intent openPage1= new Intent(HomeServizioCatering.this, ListaEventiRistorazione.class);
            startActivity(openPage1);
        }
