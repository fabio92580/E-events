...
public class ListaEventiPrenotati extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_eventi_prenotati);
        ...
        CustomAdapterEventiPrenotati adapter = new CustomAdapterEventiPrenotati(this, R.layout.row_notifica_eventi_prenotati, list);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent openPage1 = new Intent(ListaEventiPrenotati.this, DescrizioneEvento.class);
