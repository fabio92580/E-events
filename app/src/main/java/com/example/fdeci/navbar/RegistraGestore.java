...
public class RegistraGestore extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_registra_gestore1);

    }

    public void avantiUno(View v){

        setContentView(R.layout.activity_registra_gestore2);
    ...
    public void avantiDue(View v){
        setContentView(R.layout.activity_registra_gestore3);
    }
    public void indietroTre(View v){
        setContentView(R.layout.activity_registra_gestore2);
    }

    public void avantiTre(View v){
        setContentView(R.layout.activity_registra_gestore4);
    }

    public void indietroQuattro(View v){
        setContentView(R.layout.activity_registra_gestore3);
    }
