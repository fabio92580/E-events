...
public class HomeUtenteRegistrato extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_cerca_locali) {
            Intent openPage1= new Intent(HomeUtenteRegistrato.this, CercaLocali.class);
            startActivity(openPage1);        }
        else if (id == R.id.nav_cerca_eventi) {
            Intent openPage1= new Intent(HomeUtenteRegistrato.this, CercaEventi.class);
            startActivity(openPage1);
            ...
            Intent openPage1= new Intent(HomeUtenteRegistrato.this, AggiungiLocale.class);
            startActivity(openPage1);
        }else if (id == R.id.nav_crea_evento) {
            Intent openPage1= new Intent(HomeUtenteRegistrato.this, CreaEvento.class);
            startActivity(openPage1);
            ...
            Intent openPage1= new Intent(HomeUtenteRegistrato.this, DescrizionePR.class);
            startActivity(openPage1);
        }else if (id == R.id.nav_proposte) {
            Intent openPage1= new Intent(HomeUtenteRegistrato.this, ListaProposteEventi.class);
            startActivity(openPage1);
        }
