...
public class CustomAdapterEventiPrenotati extends ArrayAdapter<EventoFabio> {

    public CustomAdapterEventiPrenotati(Context context, int textViewResourceId,
                               List objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = inflater.inflate(R.layout.row_notifica_eventi_prenotati, null);
